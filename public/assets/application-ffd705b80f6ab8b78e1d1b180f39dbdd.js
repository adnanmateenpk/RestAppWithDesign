...
function setTimeFromSlot(time,submission,object){
	var t1= time.split(" ");
	var t2 = t1[0].split(":");
	var t3= t2[0]+":"+t2[1];
	time=t3+ " " + t1[1];
	...
	if(submission===0){
		...
		console.log($("#reservation_branch_id").val());
	}
}
	...
	$.ajax({	
			...
			success: function(result){
				...
				if(result.available && result.user_signed_in){
	        		...
	        		$("#slots td").unbind( "click" ).click(function(){ setTimeFromSlot($(this).html(),0,this)});
	        		...
	        		$("table#slots tbody").html(html);
	        		$("#slots td").unbind( "click" ).click(function(){ setTimeFromSlot($(this).html(),1,this)});
	        		$('#time-slots').modal('show');
				}
	        		...
	        		$("table#slots tbody").html(html);
	        		$("#slots td").unbind( "click" ).click(function(){ setTimeFromSlot($(this).html(),2,this)});
	        		$('#time-slots').modal('show');
				}
	        	else {
	        		$("#notice").html(result.message).show();
