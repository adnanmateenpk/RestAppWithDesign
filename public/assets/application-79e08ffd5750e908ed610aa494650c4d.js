	...
	$.ajax({	
			...
			success: function(result){
				...
				if(result.available && result.user_signed_in){
	        		...
	        		$("#slots td").unbind( "click" ).click(function(){ setTimeFromSlot($(this).html(),0)});
	        		...
	        		$("table#slots tbody").html(html);
	        		$("#slots td").unbind( "click" ).click(function(){ setTimeFromSlot($(this).html(),1)});
	        		$('#time-slots').modal('show');
				}
	        		...
	        		$("table#slots tbody").html(html);
	        		$("#slots td").unbind( "click" ).click(function(){ setTimeFromSlot($(this).html(),2)});
	        		$('#time-slots').modal('show');
				}
	        	else {
	        		$("#notice").html(result.message).show();
